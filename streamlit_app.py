        ...
        if selected_sub_menu == "유사국면분석":
            ...
            if sel_edt == df_simdt['EDATE'].max():
                if sel_simdt == fil_dt.iloc[0]:  # 첫 번째 값일 때
                    st.write("2016년 6월 2일부터 2017년 2월 8일까지의 주요 매크로 이벤트로는 브렉시트 국민투표(2016년 6월 23일), 트럼프 미국 대통령 당선(2016년 11월 8일), 연준의 금리 인상(2016년 12월 14일) 등이 있었다. 브렉시트 결정 직후 글로벌 금융시장은 충격을 받으며 안전자산 선호가 강해졌고, 이에 따라 미국 국채 금리는 급락, 신용 스프레드는 확대, 달러 인덱스는 하락했다. 그러나 이후 불확실성이 완화되면서 점차 회복세를 보였다. 트럼프 대통령 당선 후에는 재정 확대 및 감세 정책 기대감으로 미국 국채 금리는 급등(트럼프 리플레이션), 신용 스프레드는 축소, 달러 인덱스는 상승했다. 같은 기간 미국 주식시장은 강세를 보이며 S&P 500 지수가 사상 최고치를 경신했고, 이머징 주식시장도 연준의 점진적 금리 인상 기조와 위험자산 선호에 힘입어 상승했다. 금 가격은 브렉시트 이후 급등했으나, 트럼프 당선 이후 달러 강세와 금리 상승으로 하락했다. 국제유가는 OPEC의 감산 합의(2016년 11월 30일)와 글로벌 경기 회복 기대감으로 상승세를 보였다.")
                elif sel_simdt == fil_dt.iloc[1]:
                    st.write("2023년 3월 30일부터 2023년 11월 22일까지의 주요 매크로 이벤트로는 미국 실리콘밸리 은행(SVB) 파산(3월 10일), 미국 연방준비제도(Fed)의 지속적인 금리 인상, 이스라엘-팔레스타인 분쟁 격화(10월 초) 등이 있었습니다. SVB 파산 이후 금융 시스템에 대한 우려로 안전자산 선호가 강화되어 미국 국채 금리는 일시적으로 하락하였으나, 이후 연준의 금리 인상 기조 지속으로 국채 금리는 다시 상승세를 보였습니다. 신용 스프레드는 금융 불안정성에 따라 일시적으로 확대되었으나, 이후 안정세를 되찾았습니다. 달러 인덱스는 연준의 긴축 정책과 글로벌 불확실성으로 상승세를 보였으며, 미국 주식시장은 금리 인상과 기업 실적에 대한 우려로 변동성을 나타냈습니다. 신흥국 주식시장은 달러 강세와 글로벌 경기 둔화 우려로 약세를 보였고, 금 가격은 안전자산 선호로 상승세를 보이다가, 달러 강세의 영향으로 일부 조정을 겪었습니다. 국제 유가는 중동 지역의 지정학적 긴장과 수요 전망 변화에 따라 변동성을 보였습니다.")
                elif sel_simdt == fil_dt.iloc[2]:
                    st.write("2010년 8월 10일부터 2011년 4월 18일까지의 주요 매크로 이벤트로는 미국 연방준비제도(Fed)의 QE2(양적완화 2차) 발표(2010년 11월 3일), 유럽 재정위기 지속, 중동·북아프리카 지역의 정치적 불안(아랍의 봄, 2010년 12월~), 일본 대지진(2011년 3월 11일) 등이 있었다. QE2 발표 이후 풍부한 유동성 공급 기대감으로 미국 국채 금리는 상승, 신용 스프레드는 축소되었으며, 달러 인덱스는 약세를 보였다. 미국 주식시장은 연준의 완화적 정책과 기업 실적 개선에 힘입어 강세를 나타냈고, 이머징 주식시장도 글로벌 유동성 증가로 상승세를 보였다. 금 가격은 유럽 재정위기와 중동 정세 불안으로 인한 안전자산 수요 증가로 꾸준히 상승했다. 국제유가는 아랍의 봄으로 인한 원유 공급 불안과 글로벌 경기 회복 기대감으로 상승세를 지속했다.")
                elif sel_simdt == fil_dt.iloc[3]:
                    st.write("2009년 10월 9일부터 2010년 5월 6일까지의 주요 매크로 이벤트로는 글로벌 금융위기 이후 경기 회복 기대 강화, 유럽 재정위기(그리스 위기 본격화), 연준의 초저금리 정책 지속 등이 있었다. 경기 회복 기대감과 위험자산 선호로 미국 국채 금리는 상승세를 보였으며, 신용 스프레드는 축소되었다. 달러 인덱스는 유럽 재정위기 심화로 유로화 약세에 따른 반사이익으로 강세를 보였으며, 미국 주식시장은 글로벌 경기 회복 기대와 기업 실적 개선으로 강세를 보였다. 이머징 주식시장도 유동성 증가와 위험자산 선호로 상승세를 나타냈다. 금 가격은 글로벌 유동성 확대와 안전자산 수요로 강세를 유지했다. 국제유가는 글로벌 경기 회복 기대감과 원자재 수요 증가 전망에 따라 상승세를 보였다.")
